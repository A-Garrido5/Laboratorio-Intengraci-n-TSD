...
public class ConexionCliente {
    ...
    private IBoard servidor; //Interface necesaria para la comunición con el objecto del servidor
    ...
    public boolean iniciarRegistro(String IP, int Puerto, String nombreObjetoRemoto) throws RemoteException {
        try {
            ...
            servidor = (IBoard) registry.lookup(nombreObjetoRemoto);
    ...
    public IBoard getServidor() {
        return servidor;
    }

    public void setServidor(IBoard servidor) {
